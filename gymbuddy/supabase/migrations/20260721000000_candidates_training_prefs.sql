-- get_candidates_nearby zwraca teraz takze intensywnosc, dlugosc sesji i flage asekuracji
...
create or replace function public.get_candidates_nearby(
  ...
  radius_km double precision default 50, gender_filter text default ''::text,
  min_age integer default 0, max_age integer default 0,
  fitness_filter text default ''::text, min_exp integer default 0, max_exp integer default 0
)
 returns table(
   ...
   training_intensity text, session_length text, looking_for_spotter boolean,
